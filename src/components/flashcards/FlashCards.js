            ...
            {state.groupData.map((elem, index) => {
                ...
                return (index === state.showNum ?
                    ...
                    <div key={index}>
                        ...
                        <div>
                            <Link to='/flashcardgroup' className='flex items-center font-bold text-black'>
                        ...
                        <div
                                ...
                                <ul>
                                    {elem.state.map((childElement, childIndex) => {
                                        return (
                                            <li
                                                key={childIndex}
                                                style={cardHandler === childIndex ?
                                                    { color: 'red' } : { color: 'initial' }}
                                                onClick={() => setCardHandle(childIndex)}
                                                className={`px-5 py-2 cursor-pointer ${cardHandler === childIndex ? 'text-red-500 font-bold' : ''}`}>
                            ...
                            <div className='w-full lg:w-2/4 sm:w-full'>
                                    ...
                                    return (
                                        cardHandler === childIndex ?
                                            <div
                                                ...
                                                <div
                                                    className='w-full text-justify sm:mt-6 lg:mt-0 sm:w-full lg:w-5/5'>
                                ...
                                <div
                                    ...
                                    <span className='text-2xl '>{cardHandler + 1}/{elem.state.length}</span>
                                    <span
            ...
            <div className='popupBox' style={{ display: share }}>
                <div className='relative w-11/12 xl:w-2/5 sm:w-11/12 p-3 sm:p-8 bg-white rounded-md '>
                    ...
                    <div
                        ...
                        <p
                            className='w-3/4 px-4 py-3 rounded-md outline-dashed outline-1 outline-blue-200'>
                            <span>Link :</span>&nbsp;&nbsp;
                            <span>{url}</span>
                        </p>
