...
export const Reducer = (state = initialState, action) => {
    ...
    switch (action.type) {
        case ADD_INPUT_BOX:
            localStorage.setItem('card-input', JSON.stringify([...state.inputData, action.payloade]));
            return {
                ...state,
        ...
        case ADD_GROUP:
            ...
            localStorage.setItem('groupData', JSON.stringify([...state.groupData, action.payloade]))
            return {
                ...state,
